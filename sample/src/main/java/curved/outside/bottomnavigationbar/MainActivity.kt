...
//        }
        curvedOutsideBottomNav.setItems(
            CurvedOutsideBotNavItem("test1", R.drawable.ic_analytics),
            CurvedOutsideBotNavItem("test2", R.drawable.ic_analytics),
            CurvedOutsideBotNavItem("test3", R.drawable.ic_analytics),
            CurvedOutsideBotNavItem("test4", R.drawable.ic_analytics),
            CurvedOutsideBotNavItem("test5", R.drawable.ic_analytics)
        )
